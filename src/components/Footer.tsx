        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 pb-8 border-b border-primary/10">
          <div className="flex flex-col">
            ...
            <div className="flex items-center space-x-2 mt-auto">
              <Badge variant="outline" className="border-primary/30 text-primary">2024</Badge>
          ...
          <div className="flex flex-col">
            ...
            <div className={`${theme === 'dark' ? 'text-white/60' : 'text-foreground/60'} text-sm`}>
              <div className="flex items-center mb-1">
                ...
                <a href="mailto:imgtk17@gmail.com" className="hover:text-primary transition-colors">imgtk17@gmail.com</a>
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:8008133117" className="hover:text-primary transition-colors">8008133117</a>
              </div>
            </div>
          </div>
        </div>
