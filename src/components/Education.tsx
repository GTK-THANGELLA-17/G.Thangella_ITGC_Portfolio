import { BookOpen, Calendar, Award, School } from 'lucide-react';
...
const Education = () => {
  ...
  const educationData = [
    {
      degree: 'B.Sc (Hons) in Computer Science and Game Development',
      ...
      icon: <School className="h-12 w-12 text-primary group-hover:scale-110 transition-transform duration-300" />,
      coursework: 'Game Development, Software Engineering, Object-Oriented Programming, Database Systems, Computer Graphics, Network Security, Agile Methodologies',
      skills: 'Full-stack development, project management, Git version control, code optimization, technical documentation, team collaboration, debugging and testing',
      achievements: 'Led final-year Assault-Man game project as team lead, recognized as Best Student and Game Developer, organized game design and development workshop, contributed to college tech magazine.',
    },    
    {
    ...
    <section id="education" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <Badge variant="outline" className="px-4 py-1.5 text-sm font-medium mb-4 animate-fade-in border-primary/30 text-primary">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          {educationData.map((edu, index) => (
            <Card
              key={index}
              className={`overflow-hidden relative hover:shadow-xl transition-all duration-500 hover:-translate-y-2 card-3d ${
              ...
              <CardContent className="p-8 relative z-10">
                <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                  ...
                  <div className="flex-1">
                    ...
                    <h4 className="text-xl font-medium text-primary mt-1">{edu.institution}</h4>
                    ...
                    <div className="mt-4 flex flex-wrap gap-4">
                      <div
                        ...
                        } px-4 py-2 rounded-full bg-primary/5`}
                      >
